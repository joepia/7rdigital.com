...
<head>
    ...
    <script type="text/javascript" src="//use.typekit.net/oqi8wic.js"></script>
...
<body class="home">
	...
	<section id="main" class="main">
		<div class="wrapper cf">
		    <p>We are digital content</p>
			<h2 class="title"><span>creators,</span>
...
<!--
	<footer class="cf">
		<div class="wrapper cf">
			<p class="copyright">&copy;<?php echo date('Y'); ?> 7R Digital / Denver, CO / <a href="mailto:hello@7rdigital.com">hello@7rdigital.com</a></p>
		</div>
	</footer>
-->
